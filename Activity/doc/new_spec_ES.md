...
```  
Aquí hay un ejemplo de una actividad en formato JSON como normalizada. Esto es compatible con NGSI V2 cuando se usa "opciones=valores clave" y devuelve los datos de contexto de una entidad individual.  
...
```  
Aquí hay un ejemplo de una actividad en formato JSON-LD como valores clave. Esto es compatible con NGSI-LD cuando no se usan opciones y devuelve los datos de contexto de una entidad individual.  
