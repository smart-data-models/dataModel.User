...
- `refAgent`: Référence à l'agent (c'est-à-dire une personne) réalisant l'activité. Il peut s'agir d'une autre entité NGSI ou de tout `Agent` identifié par un URI.  
