...
class Activity(BaseModel):
    ...
    dateActivityEnded: Optional[AwareDatetime] = Field(
        None, description="Activity's end timestamp"
    )
    dateActivityStarted: Optional[AwareDatetime] = Field(
        None, description='It must be equal to UserActivity'
    )
    ...
    ] = Field(None, description='Reference to the target of the action (e.g. Office1)')
    ...
    type: Optional[Type6] = Field(
        None, description='NGSI Entity type. It has to be Activity'
    )
